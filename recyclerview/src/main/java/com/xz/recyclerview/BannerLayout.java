...
import com.xz.recyclerview.manager.BannerLayoutManager;
import com.xz.recyclerview.manager.CenterSnapHelper;
import com.xz.recyclerview.utils.ResUtils;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mItemSpace = a.getDimensionPixelSize(R.styleable.BannerLayout_bl_itemSpace, ResUtils.getDimensionPixelSize(getContext(),R.dimen.default_recycler_banner_itemSpace));
        ...
        int indicatorSize = a.getDimensionPixelSize(R.styleable.BannerLayout_bl_indicatorSize, ResUtils.getDimensionPixelSize(getContext(),R.dimen.default_recycler_banner_indicatorSize));
        int indicatorSelectedColor = a.getColor(R.styleable.BannerLayout_bl_indicatorSelectedColor, ResUtils.getColor(getContext(),R.color.xui_config_color_red));
        int indicatorUnselectedColor = a.getColor(R.styleable.BannerLayout_bl_indicatorUnselectedColor, ResUtils.getColor(getContext(),R.color.xui_config_color_gray_2));
        ...
        mIndicatorMargin = a.getDimensionPixelSize(R.styleable.BannerLayout_bl_indicatorSpace, ResUtils.getDimensionPixelSize(getContext(),R.dimen.default_recycler_banner_indicatorSpace));
        int marginLeft = a.getDimensionPixelSize(R.styleable.BannerLayout_bl_indicatorMarginLeft, ResUtils.getDimensionPixelSize(getContext(),R.dimen.default_recycler_banner_indicatorMarginLeft));
        int marginRight = a.getDimensionPixelSize(R.styleable.BannerLayout_bl_indicatorMarginRight, ResUtils.getDimensionPixelSize(getContext(),R.dimen.default_recycler_banner_indicatorMarginRight));
        int marginBottom = a.getDimensionPixelSize(R.styleable.BannerLayout_bl_indicatorMarginBottom, ResUtils.getDimensionPixelSize(getContext(),R.dimen.default_recycler_banner_indicatorMarginBottom));
