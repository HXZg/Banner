...
package com.xz.recyclerview.manager;
...
public class BannerLayoutManager extends RecyclerView.LayoutManager {
    ...
    protected void setItemViewProperty(View itemView, float targetOffset) {
        ...
        /*float v = (scale - 1) / (centerScale - 1);
        Log.i("zzzzzzzzz",scale +":::"+v);
        itemView.setAlpha(v);*/
    }
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        ensureLayoutState();  // 创建orientation help
        resolveShouldLayoutReverse();  // 是否反转布局 (horizontal)

        //make sure properties are correct while measure more than once
        View scrap = recycler.getViewForPosition(0);  // 得到第一个子view
        measureChildWithMargins(scrap, 0, 0); // 测量子view
